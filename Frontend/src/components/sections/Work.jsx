  ...
  const projects = [
    {
      ...
      description: "TRAZEX11 is a stock market-based fantasy gaming platform where users create virtual teams using stocks instead of sports players.",
    },
    {
      id: 2,
      category: "UI/UX Design",
      ...
      imageUrl: "https://res.cloudinary.com/dbrb9ptmn/image/upload/v1742497642/kxrtmszauv8nz6qnjryb.png",
      url: "https://www.figma.com/design/5FzaWNrX0zAdTpEXdIXkfj/My-Free?node-id=1949-239",
      description: "A modern, user-friendly interface for ScanX, a document scanning and comparison platform.",
    },
    {
      id: 3,
      category: "Mobile Development",
      ...
      description: "Full-stack mobile expense tracker with Clerk authentication and real-time balance updates.",
    },
