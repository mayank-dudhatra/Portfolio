              ...
              <div className="relative z-10 bg-white/[0.03] backdrop-blur-sm rounded-3xl overflow-hidden border border-white/10 group-hover:border-[#80db66]/30 transition-all duration-500 shadow-2xl">
                ...
                <div className="relative h-60 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center translate-y-4 group-hover:translate-y-0">
                    <a 
                      ...
                      className="bg-white text-black px-6 py-2.5 rounded-full font-bold text-xs uppercase tracking-widest hover:bg-[#80db66] transition-colors shadow-xl"
                    >
                      Verify Credential
                    </a>
                  </div>
                ...
                <div className="p-8">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="text-[#80db66] text-xs font-bold uppercase tracking-[0.2em]">
                      {cert.platform}
                    </p>
                  </div>
                  <h3 className="text-[#4d4d5c] text-xl font-semibold leading-snug group-hover:text-[#80db66] transition-colors duration-300">
                    {cert.title}
                  </h3>
                </div>
              </div>

              {/* Decorative Card Shadow (Glow on Hover) */}
